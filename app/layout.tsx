...
export const metadata: Metadata = {
  ...
  title: {
    default: "תומכים בעורף, קונים נכון - אינדקס עסקים מהצפון",
    template: "%s | תומכים בעורף, קונים נכון",
  },
  description:
  ...
  openGraph: {
    type: "website",
    locale: "he_IL",
    siteName: "תומכים בעורף, קונים נכון",
    title: "תומכים בעורף, קונים נכון - אינדקס עסקים מהצפון",
    description:
      "אינדקס עסקים מקריית שמונה ויישובי קו העימות. תמכו בצפון - הזמינו מבעלי מקצוע מהאזור שנפגע.",
  },
  twitter: {
    card: "summary_large_image",
    title: "תומכים בעורף, קונים נכון",
